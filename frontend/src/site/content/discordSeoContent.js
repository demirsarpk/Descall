...
export const COMPARE_FAQ = [
  {
    ...
    a: "Yes. Descall is a free Discord alternative for real-time chat, group voice/video, screen share, and gamer-focused LFG — without Nitro paywalls for core features.",
  },
  {
    q: "Can Descall replace Discord for friend groups?",
    a: "For friend groups and small communities that mainly need DMs, group chat, voice, and screen share, Descall is a strong lighter alternative. Very large server ecosystems still favor Discord today.",
  },
  {
    q: "Does Descall have screen sharing?",
    a: "Yes. Descall supports screen share in DM and group calls with quality presets designed for smooth sharing.",
  },
  {
...
export const ALTERNATIVE_PILLARS = [
  {
    ...
    body: "Descall prioritizes DMs, groups, presence, and a dedicated Play tab for Valorant LFG — so you spend less time fighting server sprawl and more time queueing with people you know.",
  },
  {
    title: "Calls without the bloat",
    body: "WebRTC voice/video with TURN support, incoming call UX, PiP, and screen-share quality controls. A lighter Discord alternative when you want clean calls, not a second operating system.",
  },
  {
    title: "Free core, optional cosmetics",
    body: "Chat and calls are free. The shop is cosmetic (themes, frames, effects) via DesCoin — not a Nitro-style lock on quality of life for talking to friends.",
  },
  {
...
export const GAMER_FAQ = [
  {
    ...
    a: "If you want chat, voice, screen share, and built-in Valorant LFG without Nitro, Descall is a strong Discord alternative for gaming friend groups.",
  },
  {
...
export const TURKEY_FAQ = [
  {
    ...
    a: "Descall; sohbet, ses/görüntülü arama, ekran paylaşımı ve Valorant LFG odaklı ücretsiz bir Discord alternatifidir. Arkadaş grupları ve oyuncu ekipleri için daha hafif bir deneyim sunar.",
  },
  {
    q: "Türkiye’den Discord alternatifi arıyorum — Descall uygun mu?",
    a: "Evet. Türkçe arayüz desteği, web + Windows istemcisi ve Android ile Descall, Türkiye’deki oyuncu grupları için pratik bir Discord alternatifidir.",
  },
  {
...
export const BLOG_POSTS = [
  {
    ...
    description:
      "An honest Discord vs Descall comparison for chat, voice, screen share, LFG, and pricing — when a lighter Discord alternative wins.",
    date: "2026-08-11",
  ...
  },
  {
    ...
    description:
      "How to move a friend group from Discord Nitro habits to a free Discord alternative with voice, video, and screen share.",
    date: "2026-08-11",
