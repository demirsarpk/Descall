-- Descall Servers (Discord-parity) — Step 0/1
-- Drop legacy guild scaffolding, create new server schema.

-- ─── Step 0: remove old guild tables ─────────────────────────────────
...
-- ─── Discord parity pack: app commands, moderation, community ─────────
